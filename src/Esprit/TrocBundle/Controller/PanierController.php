...
class PanierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $paniers = $em->getRepository('EspritTrocBundle:Panier')
    ...
    {
        $panier = new Panier();
        $form = $this->createForm('Esprit\TrocBundle\Form\PanierType', $panier);
    ...
    {
        $deleteForm = $this->createDeleteForm($panier);
        $editForm = $this->createForm('Esprit\TrocBundle\Form\PanierType', $panier);
